...
F-statistic and subsequently tested for cointegration. The hypotheses were:
...
procedure, the RBFNN
model as shown in Figure \ref{fig:rbf_nn_architecture} is obtained.
...
framework was used to conduct the train-test process as follows:
\begin{enumerate}
...
market's value they ought to adopt a lower interest rate regime. This will 
