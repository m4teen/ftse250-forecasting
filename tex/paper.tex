...
macroeconomic policy in this crash was central, and the effects of the crash 
devastated the economy through rampant inflation. Nonetheless, stock markets also provide essential benefits by allowing companies to 
raise capital, offering investment opportunities for individuals, and 
supporting economic growth through efficient capital allocation (\citeboth{shahbaz2016}). Effective, sustainable
...
relevance to investors. Changes in macroeconomic indicators have an effect on both consumer preferences
and business costs which impacts the profitability of firms. This 
leads to discrepancies between the valuation of firms by investors and 
stock prices, which in turn drives trends in the stock 
market price. 
...
to forecast stock market prices over the long-term and short-term, both useful to 
economic policy makers and stock market investors respectively. 
Modelling of this kind typically involves choosing 
the most appropriate method from a variety: statistical analysis, 
econometric modelling, scenario planning, and machine learning 
techniques. Also, careful economic analysis is required to select
the macroeconomic indicators most relevant in 
the dynamics of a nation's stock market.

The objective of this study is to address how specific 
macroeconomic indicators influence stock market prices in a developed economy, and whether machine 
learning models can substitute traditional econometric models in predicting stock market prices. 
Ultimately, it aims to investigate two aspects of the influence of macroeconomic 
indicators on stock markets: 
\begin{enumerate}
    \item To examine the short-term and long-term effects of macroeconomic indicators on the price of the FTSE250 
...
In order to analyse the dynamic relationship between variables in 
time series data, this study will employ the Autoregressive Distributed 
Lag (ARDL) model in conjunction with an Error Correction Model (ECM). 
This research also employs a radial basis function neural network (RBFNN) to 
predict the price movements of the FTSE250.

The remainder of the paper is organised as follows. 
Section 2 presents a brief review of the literature in this problem space, 
and explains the rationale behind the selection of macroeconomic variables. 
Section 3 covers the data utilised in this study. Section 4 outlines the 
ARDL-ECM model and the results achieved. 
Section 5 constructs the RBFNN 
model, and presents the forecasting results. Section 6 concludes the study.
